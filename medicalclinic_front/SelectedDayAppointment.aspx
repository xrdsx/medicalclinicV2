...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <center><h3>List of appointments for today</h3>
            <center> <asp:Label ID="Label1" runat="server" Text="Label" Visible="False"></asp:Label> 
                <br />
                <br />
        </center>
        </center>
    <asp:GridView ID="GridView_todays" runat="server" AllowSorting="True" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" CellPadding="4" EnableSortingAndPagingCallbacks="True" ForeColor="#333333" GridLines="None" Height="85px" HorizontalAlign="Center" style="text-align: right;" Width="724px">
